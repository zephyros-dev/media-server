...
parser.add_argument(
    "--dry-run", type=bool, default=True, help="Print the result of the run only"
)
parser.add_argument(
    "--protocol",
    default="https",
...
for torrent in torrent_list:
    ...
    print(
        f"Torrent ID: {torrent.id}, Torrent Name: {torrent.name}, Old path: {torrent.download_dir}, New path: {new_dir}"
    )
